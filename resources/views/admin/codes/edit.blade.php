...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.codes.update", [$code->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" type="text" name="code" id="code" value="{{ old('code', $code->code) }}" required>
                @if($errors->has('code'))
                    <div class="invalid-feedback">
                        {{ $errors->first('code') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('reserved_at') ? 'is-invalid' : '' }}" type="text" name="reserved_at" id="reserved_at" value="{{ old('reserved_at', $code->reserved_at) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('purchased_at') ? 'is-invalid' : '' }}" type="text" name="purchased_at" id="purchased_at" value="{{ old('purchased_at', $code->purchased_at) }}">
